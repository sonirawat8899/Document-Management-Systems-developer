...
class PermissionController extends Controller
{
    public function module_permissioN(){
        $companyId= auth()->user()->id;
          ...
          return view('user.permission.module_permission')->with(['users'=>$users,'modules'=>    $modules]);
      }
      ...
      public function permission(Request $request){
          ...
          return  redirect('user/module_permission')->with('success', 'Permission give successfully.');
      }
}
