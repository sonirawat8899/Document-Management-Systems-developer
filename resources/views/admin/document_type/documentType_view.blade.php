    ...
    <div class="page-inner">
        ...
        <div class="card-header">
            ...
            <div class="d-flex align-items-center">
                <a href="{{ url('admin/documentType_add') }}"><button class="btn btn-primary btn-round ml-auto"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action_td">
                                ...
                                <a href="{{url('admin/documentType_edit/'. $documentTypes->id) }}" data-toggle="tooltip"
                                ...
                                <a href="{{url('DocumentTypeChangeStatus/'. $documentTypes->id.'/'. $status) }}"
                                ...
                                <a href="{{url('admin/documentType_delete/'. $documentTypes->id) }}"
