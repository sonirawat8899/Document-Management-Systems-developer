                                        ...
                                        <tr>
                                            ...
                                            <td class="action_td">
                                                <div class="form-button-action">
                                                    <a href="{{ url('admin/edit_notification/' . $notification->id) }}"
                                                    ...
                                                    <a href="{{ url('NotificationChangeStatus/' . $notification->id . '/' . $status) }}"
                                                    ...
                                                    <a href="{{ url('admin/delete_notification/' . $notification->id) }}"
