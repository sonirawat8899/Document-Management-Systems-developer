                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ url('company/addcontent') }}"><button class="btn btn-primary btn-round ml-auto"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action_td">
                                            ...
                                            <a href="{{url('/company/update_content/' . $cms->id) }}"
                                            ...
                                            <a href="{{url('company/CMSChangeStatus/'. $cms->id.'/'. $status) }}"
                                            ...
                                            <a href="{{ url('/company/delete_content/' .  $cms->id) }}"
