    ...
    <div class="page-inner">
        ...
        <div class="card-header">
            ...
            <div class="d-flex align-items-center">
                <a href="{{ url('company/documentType_add') }}"><button class="btn btn-primary btn-round ml-auto"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="action_td">
                                ...
                                <a href="{{url('company/documentType_edit/'. $documentTypes->id) }}" data-toggle="tooltip"
                                ...
                                <a href="{{url('/company/DocumentTypeChangeStatus/'. $documentTypes->id.'/'. $status) }}"
                                ...
                                <a href="{{url('company/documentType_delete/'. $documentTypes->id) }}"
