                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ url('company/content') }}"><button class="btn btn-primary btn-round ml-auto"
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatables" class="display table table-striped table-hover">
                                ...
                                <a href="{{url('company/edit_content/'. $emailContent->id) }}" data-toggle="tooltip"
                                ...
                                <a href="{{url('/company/EmailContentChangeStatus/'. $emailContent->id.'/'. $status) }}"
                                ...
                                <a href="{{url('company/delete/'. $emailContent->id) }}"
