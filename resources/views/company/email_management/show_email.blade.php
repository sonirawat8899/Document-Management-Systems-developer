                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ url('company/email') }}"><button class="btn btn-primary btn-round ml-auto"
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <td class="action_td">
                                    ...
                                    <a href="{{url('company/edit_email/'. $emailType->id) }}" data-toggle="tooltip"
                                    ...
                                    <a href="{{url('/company/EmailTypeChangeStatus/'. $emailType->id.'/'. $status) }}"
                                    ...
                                    <a href="{{url('company/emaildelete/'. $emailType->id) }}"
