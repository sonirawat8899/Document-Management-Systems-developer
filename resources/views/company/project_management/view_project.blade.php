                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ url('company/project') }}"><button class="btn btn-primary btn-round ml-auto"
                            ...
                            <table id="datatables" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action_td">
                                            <a href="{{ url('/company/update_project/' .$project->id) }}"
                                            ...
                                            <a href="{{url('/company/ProjectChangeStatus/'. $project->id.'/'. $status) }}"
                                            ...
                                            <a href="{{ url('company/delete_project/' .$project->id) }}"
