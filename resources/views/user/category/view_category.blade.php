    ...
    <div class="page-inner">
        <div class="page-header">
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="{{ url('user/view_category') }}">Category Management</a>
                </li>
                <li class="separator">
                    <i class="flaticon-right-arrow"></i>
                </li>
...
<div class="flash-message">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ url('user/category') }}"><button class="btn btn-primary btn-round ml-auto" data-toggle="modal"
             ...
             @endphp
                ...
                <td> {{ User::getCategoryID($category->parent_id) }}</td>
                    ...
                    <td class="action_td">
                        ...
                        <a href="{{ url('user/update_category/'. $category ->id)}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
                              ...
                              @php
                                                    ...
                                                    <a href="{{ url('user/categoryChangeStatus/' . $category ->id . '/' . $status) }}"
                 ...
                 <a href="{{ url('user/delete_category/'.$category->id)}}"
