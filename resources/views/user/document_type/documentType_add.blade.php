    ...
    <div class="page-inner">
        <div class="page-header">
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="{{url('user/documentType_view')}}">Document Management</a>
                </li>
                <li class="separator">
                    <i class="flaticon-right-arrow"></i>
                </li>
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form action="{{url('user/documentType_add')}}" method="post" id="validate">
                        @csrf
...
<script>
   ...
   // alert('aaaa');
    ...
    $.ajax({
      type: "GET",
      url: "/user/checkDocumentType?name="+name,
