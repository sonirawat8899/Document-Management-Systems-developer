    ...
    <div class="page-inner">
        <div class="page-header">
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="{{url('user/documentType_view')}}">Document Type</a>
                </li>
                <li class="separator">
                    <i class="flaticon-right-arrow"></i>
                </li>
            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('user/documentType_update')}}" method="post" id="validateform">
                            @csrf
                            ...
                            <div class="text-right">
                                ...
                                <a href="{{url('user/documentType_view')}}" class="mt-4 btn btn-danger">Cancel</a>
                                <div>
                        </form>
                    </div>
                </div>
...
<script>
   $(document).ready(function(){
    ...
    $("#name").blur(function(){
        ...
        $.ajax({
            type: "GET",
            url: "/user/checkDocumentType",
            data: {'name':name,'id':id},
            success: function(response)
            {
                console.log(response);
                if(response == 1){
                $('#name_err').text('This user is already exist');
