        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('user/show_content') }}">Email Management</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Add Email Content</div>
                        </div>
                        <div class="card-body">
                            <form action="add_content" id="form" method="POST">
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="{{ url('user/show_content') }}" class="mt-4 btn btn-danger">Cancel</a>
                                    <div>
                            </form>
                        </div>
                        <script>
