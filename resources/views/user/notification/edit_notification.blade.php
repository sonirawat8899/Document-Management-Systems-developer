        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('user/show_notification') }}">Notification Management</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ url('user/update_notification') }}" id="form" method="POST">
                                @csrf
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="{{ url('user/show_notification') }}" class="mt-4 btn btn-danger">Cancel</a>
                                    <div>
                            </form>
                        </div>
                    </div>
