                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ url('user/notification') }}"><button class="btn btn-primary btn-round ml-auto"
                                        ...
                                        <tr>
                                            ...
                                            <td class="action_td">
                                                <div class="form-button-action">
                                                    <a href="{{ url('user/edit_notification/' . $notification->id) }}"
                                                    ...
                                                    <a href="{{ url('user/NotificationChangeStatus/' . $notification->id . '/' . $status) }}"
                                                    ...
                                                    <a href="{{ url('user/delete_notification/' . $notification->id) }}"
