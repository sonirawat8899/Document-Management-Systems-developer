                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ url('user/project') }}"><button class="btn btn-primary btn-round ml-auto"
                            ...
                            <table id="datatables" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action_td">
                                            <a href="{{ url('/user/update_project/' .$project->id) }}"
                                            ...
                                            <a href="{{url('/user/ProjectChangeStatus/'. $project->id.'/'. $status) }}"
                                            ...
                                            <a href="{{ url('user/delete_project/' .$project->id) }}"
